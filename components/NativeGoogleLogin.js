...
export default function NativeGoogleLogin({ sendUserData, loginFailed }) {
  GoogleSignin.configure({
    ...
    webClientId:
      "825050207640-dl3lgst2p52hnorr4he6c6k125pn2n9f.apps.googleusercontent.com", // client ID of type WEB for your server (needed to verify user ID and offline access)
