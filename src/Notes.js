...
export class NotePack {
  constructor() {
    ...
    this.list = [
      {
        clue: "What is holey, made out of metal, and yellow at Calvin?",
        archived: true,
        points: 5,
        key: "0",
      },
      {
        clue: "The better dining hall's entrance.",
        archived: true,
        points: 2,
        key: "1",
      },
      {
        clue: "Not starbucks... Seriously, it isn't Starbucks.",
        archived: false,
        points: 2,
        key: "2",
      },
      ...
      {
        clue:
          "The worst dining hall's entrance. The worst dining hall's entrance. The worst dining hall's entrance. The worst dining hall's entrance. The worst dining hall's entrance. The worst dining hall's entrance. ",
        archived: false,
        points: 5,
        key: "9",
      },
